...
public class BloomFilter<E> implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        BloomFilter<String> bf = new BloomFilter<String>(0.001,8);
        for (int i = 0; i < s.length; i++) {
            bf.add(s[i]);
        }

        System.out.println("nic : "  + bf.contains("nic"));
        System.out.println("cos : "  + bf.contains("cos"));
        System.out.println("pies : "  + bf.contains("pies"));
        System.out.println("piesel : "  + bf.contains("piesel"));
        System.out.println("waltornia : "  + bf.contains("waltornia"));
        System.out.println("gitara : "  + bf.contains("gitara"));
        System.out.println("cho : "  + bf.contains("cho"));
    }
}