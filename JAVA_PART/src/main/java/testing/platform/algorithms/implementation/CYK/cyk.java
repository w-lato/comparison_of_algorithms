package testing.platform.algorithms.implementation.CYK;
...
//        }
    ...
    public static void main (String args[]) {
        //String input = "aaab aaba aaaa abbb aaab abaa aaab aaaa"; //14 07 1410
        String input = "0001 0010 0000 0111 0001 0100 0001 0000"; //14 07 1410
        input = input.replace(" ","");
        //Scanner in = new Scanner (System.in);
        Grammar Grammar = new Grammar ("C:\\Users\\wlato\\IdeaProjects\\engineers_thesis\\JAVA_PART\\src\\main\\java\\test\\algorithms\\CYK\\anotherCYK\\old_cyk\\other\\grammars\\grammar5.txt");
        if (!Grammar.isRead ()) {
